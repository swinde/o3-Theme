...
$aLang = [
    ...
    'SHOP_THEME_GROUP_mode'                         => 'Mode',
    'SHOP_THEME_GROUP_form'                         => 'Registration',
    ...
    'SHOP_THEME_GROUP_colors'                       => 'Colors',
    'SHOP_THEME_GROUP_article'                      => 'Article',
    ...
    'SHOP_THEME_bInputCompany'                      => 'Show Company field',
    'SHOP_THEME_bInputFax'                          => 'Show Fax field',
    'SHOP_THEME_bInputMobilePhone'                  => 'Show mobile phone field',
    'SHOP_THEME_bInputPrivatPhone'                  => 'Show private phone field',
    'SHOP_THEME_bInputState'                        => 'Show State field',
    'SHOP_THEME_bInputUstid'                        => 'Show UstId field',
    'SHOP_THEME_iPasswordLength'                    => 'Min. Password length',
    ...
    'HELP_SHOP_THEME_sBackgroundImage'             => 'Filename in out/o3-theme/src/img/. E.g.: background.jpg',
    ...
    'SHOP_THEME_iTopNaviCatCount'                   => 'Number of categories shown in the top navigation (additional categories are listed under "more")', //SHOP_CONFIG_TOPNAVICATCOUNT
    'SHOP_THEME_blShowFinalStep'                    => 'Show order confirmation when the order is completed (fifth checkout step)', //SHOP_SYSTEM_SHOWFINALSTEP
    'SHOP_THEME_iNewBasketItemMessage'              => 'Action to perform when a product is added to the cart', //SHOP_SYSTEM_SHOWNEWBASKETITEMMESSAGE
    'HELP_SHOP_THEME_iNewBasketItemMessage'         => 'When customers add a product to the cart, O3-Shop can perform different feedback actions.', //SHOP_SYSTEM_SHOWNEWBASKETITEMMESSAGE
    'SHOP_THEME_iNewBasketItemMessage_0'            => 'None',
    'SHOP_THEME_iNewBasketItemMessage_1'            => 'Show message',
    'SHOP_THEME_iNewBasketItemMessage_2'            => 'Open popup',
    'SHOP_THEME_iNewBasketItemMessage_3'            => 'Open cart',

    'SHOP_THEME_blShowSubcatTiles'                  => 'Show subcategories as tiles',
    'HELP_SHOP_THEME_blShowSubcatTiles'             => 'Displays subcategories on category pages as image tiles. If no image is uploaded for a category, a button is shown instead.',
    'SHOP_THEME_sEnable3xl'                         => 'Enable 3XL layout (≥1720 px viewport, 5 products per row)',
    'HELP_SHOP_THEME_sEnable3xl'                    => 'Enables a wider container (1650 px) with 5 products per row in list view and product sliders at viewports ≥ 1720 px. Default: enabled.',
    'SHOP_THEME_blShowListDisplayType'              => 'Show product list type selector in product lists',
    'HELP_SHOP_THEME_blShowListDisplayType'         => 'Allow visitors to choose the list view type. If disabled, the list view is fixed to the value set in "Default product list type".',
    'SHOP_THEME_sDefaultListDisplayType'            => 'Default product list type',
    'SHOP_THEME_sDefaultListDisplayType_grid'       => 'Gallery',
    'SHOP_THEME_sDefaultListDisplayType_line'       => 'List',
    'SHOP_THEME_sDefaultListDisplayType_infogrid'   => 'Two-column gallery',
    'SHOP_THEME_sStartPageListDisplayType'          => 'Product list type on start page',
    'SHOP_THEME_sStartPageListDisplayType_grid'     => 'Gallery',
    'SHOP_THEME_sStartPageListDisplayType_line'     => 'List',
    'SHOP_THEME_sStartPageListDisplayType_infogrid' => 'Two-column gallery',
    'SHOP_THEME_sSliderAutostart'                   => 'Banner autostart',
    'SHOP_THEME_sSliderInterval'                    => 'Interval (ms)',
    'SHOP_THEME_sSliderAutostart_on'                => 'On',
    'SHOP_THEME_sSliderAutostart_off'               => 'Off',
    'SHOP_THEME_sSliderSlideFade'                   => 'Banner fade/slide',
    'SHOP_THEME_sSliderSpeed'                       => 'Speed',
    'SHOP_THEME_sSliderSlideFade_slide'             => 'slide',
    'SHOP_THEME_sSliderSlideFade_fade'              => 'fade',
    'SHOP_THEME_activateJquery'                    => 'activate JQuery',
    ...
    'HELP_SHOP_THEME_sInstagramUrl'                 => 'E.g.: https://www.instagram.com/oxid_esales/',

    'SHOP_THEME_sGoogleMapsAddr'                    => 'Your postal address',
    'HELP_SHOP_THEME_sGoogleMapsAddr'               => 'E.g.: My Company GmbH, Example Street 1, 12345 City',

    'SHOP_THEME_bl_showManufacturer'          => 'Show manufacturers on Start page',

    'SHOP_THEME_bl_articleAmountMax'                => 'Limit orderable quantity to stock level',
    'HELP_SHOP_THEME_bl_articleAmountMax'           => 'The maximum quantity of an article that can be ordered is based on the stock level. If this option is disabled, more articles can be ordered than are available in stock.',
    ...
    'SHOP_THEME_sSloganFile'                        => 'Filename of slogan in header',
    'HELP_SHOP_THEME_sLogoFile'                     => 'This is relative to the path <code>/out/o3-theme/src/img/</code>.',
    ...
    'HELP_SHOP_THEME_sEmailLogo'                    => 'This is relative to the path <code>/out/o3-theme/src/img/</code>.',

    'SHOP_THEME_sFaviconFile'                       => 'Favicon filename',
    'HELP_SHOP_THEME_sFaviconFile'                  => 'This favicon is meant to be displayed in the browser\'s tab.<br>In general, this is an ico file.<br>This is relative to the path <code>/out/o3-theme/src/img/favicons/</code>.',
    ...
    'HELP_SHOP_THEME_sBackgroundPath'               => 'This is relative to the path <code>/out/o3-theme/src/img/backgrounds/</code>.',
